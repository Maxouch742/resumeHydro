...
\begin{figure}[H]
    \centering
    \includegraphics[width=17cm]{loiDebitQ347.png}
...
\end{figure}[H]
\begin{figure}[H]
    \subfigure[Débit annuel estimés]{\includegraphics[width=17cm]{debitEstimationAnnuel.png}} \\
    \subfigure[Médiane Q347]{\includegraphics[width=17cm]{debitEtiageRegime.png}} \\
    \subfigure[Débit moyen annuel]{\includegraphics[width=17cm]{medianeDebitMoyenAnnuel.png}}
\end{figure}
